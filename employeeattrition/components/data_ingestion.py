...
from employeeattrition.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            raise EmployeeAttritionException
    ...
    def split_deata_as_train_test(self, dataframe: pd.DataFrame):
        try:
    ...
    def initia_data_ingestion(self):
        try:
            ...
            self.split_deata_as_train_test(dataframe)
